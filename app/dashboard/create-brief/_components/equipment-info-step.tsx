...
import { equipment } from "@/utils/formSchema";
import {
  Select,
  SelectContent,
  SelectItem,
  ...
  return (
    <>
      {watch("rooms") === 0 ? (
        ...
        <div className='sm:col-span-2 text-center w-full pt-10 justify-center items-center dark:text-neutral-500'>Не выбраны помещения. Размещать оборудование негде.</div>
      )}
    </>
  );
};
